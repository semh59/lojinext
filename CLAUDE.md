...
| `platform_infra` | In progress (dalga 17) — cache/events/container.py/resilience/database/monitoring/security/context/logging/audit/background/metrics/middleware taşındı, kalan: websocket + sıkılaştırma (`public.py` + yeni import-linter kontratı) | `TASKS/modules/platform-infra.md` |
