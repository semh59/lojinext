...
class AnalizRepository(BaseRepository[Sefer]):
    ...
    # NOT: get_investigation_detail/get_investigation_patterns/list_investigations/
    # get_anomaly_alarm_context/get_investigation_by_anomaly_id/create_investigation_row/
    # lock_investigation_for_update/get_investigation_by_id/update_investigation_fields/
    # close_investigation/update_investigation_classification + _INVESTIGATION_JOIN_SQL
    # dalga 8'de v2/modules/anomaly/infrastructure/investigation_repository.py'ye
    # taşındı (uow.investigation_repo). FOR-UPDATE invaryantı (lock+update_fields+
    # close aynı dosyada) yeni konumda da korunuyor.
