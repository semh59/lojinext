...
def test_classify_route_highway_dominant():
    from v2.modules.driver.application.route_profile import classify_route
...
async def test_coefficient_returns_neutral_when_insufficient_data(db_session):
    ...
    from v2.modules.driver.application.route_profile import get_driver_route_coefficient
