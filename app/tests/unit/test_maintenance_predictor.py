...
def test_risk_level_boundaries(days, expected):
    from v2.modules.fleet.application.maintenance_prediction import _risk_level
...
def test_confidence_no_data():
    from v2.modules.fleet.application.maintenance_prediction import _confidence
...
def test_savings_pct_no_data():
    from v2.modules.fleet.application.maintenance_prediction import _savings_pct
...
def _build_engine():
    from v2.modules.fleet.application.maintenance_prediction import MaintenancePredictor

    return MaintenancePredictor()


def _build_input(**overrides):
    from v2.modules.fleet.application.maintenance_prediction import PredictionInput
