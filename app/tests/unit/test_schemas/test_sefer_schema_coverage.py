...
class TestTripStatus:
    def test_all_values(self):
        from app.schemas.sefer import TripStatus
...
class TestSeferUpdateValidateIptal:
    def test_cancelled_with_reason_ok(self):
        from app.schemas.sefer import SeferUpdate, TripStatus
...
class TestBulkSchemas:
    def test_bulk_status_update(self):
        from app.schemas.sefer import SeferBulkStatusUpdate, TripStatus
...
class TestSeferListAndStats:
    ...
    def test_stats_response(self):
        from app.schemas.sefer import SeferStatsResponse
