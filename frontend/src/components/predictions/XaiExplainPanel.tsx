    ...
    <Card padding="lg" className="space-y-4">
      ...
      {isLoading ? (
        <div className="flex items-center gap-2 py-6 text-secondary">
          ...
          <span className="text-sm">Faktörler analiz ediliyor…</span>
        </div>
      ) : isError ? (
        ...
        <p className="text-sm text-secondary">
          Bu tahmin için faktör katkısı dönmedi.
        </p>
      ) : (
        <>
          ...
          <p className="text-[11px] text-secondary">
            Yüzdeler her özelliğin tahmine göreceli katkısını ifade eder;
            pozitif değer tüketimi artırma, negatif değer düşürme yönündedir.
          </p>
        </>
      )}
    </Card>
