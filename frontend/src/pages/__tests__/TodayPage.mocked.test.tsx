/**
 * 0-mock epiği notu: seed'li happy-path (3 farklı kategori item, severity
 * filtreleme/tab switch) ve 503 hata-enjeksiyonu senaryoları burada mock'lu
 * kalıyor — gerçek backend'de bu sentetik triage item'larını (anomaly +
 * maintenance + investigation, üç ayrı domain) üretmek aşırı pahalı; boş-
 * state/cold-start varyantı `TodayPage.test.tsx`'te gerçek backend'e karşı
 * kanıtlı.
 */
