...
class TestFeatureEngineEdgeCases:
    def test_string_dates_processed(self):
        ...
        from prediction_ml_service.domain.advanced_lstm import FeatureEngine
...
class TestSarimaFallback:
    def test_sarima_returns_none_on_short_data(self):
        from prediction_ml_service.domain.advanced_lstm import _sarima
...
class TestHoltWintersFallback:
    def test_holt_winters_exception_returns_none(self):
        ...
        from prediction_ml_service.domain.advanced_lstm import _holt_winters
...
class TestEnsembleStatFallback:
    def test_ensemble_stat_only_hw_succeeds(self):
        ...
        from prediction_ml_service.domain.advanced_lstm import _ensemble_stat
        ...
        with patch(
            "prediction_ml_service.domain.advanced_lstm._holt_winters",
            return_value=mock_hw,
        ):
            with patch(
                "prediction_ml_service.domain.advanced_lstm._sarima", return_value=None
            ):
    ...
    def test_ensemble_stat_only_sarima_succeeds(self):
        ...
        with patch(
            ...
            with patch(
                "prediction_ml_service.domain.advanced_lstm._sarima",
                return_value=mock_sar,
            ):
    ...
    def test_ema_fallback_on_constant_data(self):
        ...
        from prediction_ml_service.domain.advanced_lstm import _ema_fallback
...
class TestAdvancedTSEngineStatPaths:
    def test_stat_forecast_ema_path_with_1_record(self):
        ...
        from prediction_ml_service.domain.advanced_lstm import AdvancedTSEngine
...
class TestWalkForwardCV:
    def test_no_torch_returns_inf(self):
        from prediction_ml_service.domain import advanced_lstm
...
class TestSingletonThreadSafety:
    def test_singleton_is_same_object_concurrent(self):
        ...
        import prediction_ml_service.domain.advanced_lstm as mod
...
class TestDetectTrendEdge:
    def test_exactly_5_pct_increase_is_stable(self):
        ...
        from prediction_ml_service.domain.advanced_lstm import _detect_trend
