...
async def test_run_async_no_vehicles_returns_zero_counts():
    ...
    with _patch_uow_and_trainer(rows=[], trainer=mock_trainer):
        from prediction_ml_service.infrastructure.scheduler_task import _run_async
...
def test_weekly_retrain_task_exists():
    ...
    from prediction_ml_service.infrastructure.scheduler_task import (
...
def test_weekly_retrain_task_calls_run_async():
    ...
    with (
        patch(
            "prediction_ml_service.infrastructure.scheduler_task._run_async",
        ),
        patch(
            "prediction_ml_service.infrastructure.scheduler_task.asyncio.run",
